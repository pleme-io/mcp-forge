    ...
    crates = {
      ...
      "sekkei" = rec {
        ...
        src = pkgs.fetchgit {
          ...
          rev = "dd2907a5eb94fd0d6171a717c5b52bf765e073cb";
          sha256 = "0qxrdif56zqlwwq3ff6wgbpqff3c3jyil55rxx64ajid46wf2i0v";
        };
        dependencies = [
          {
            name = "serde";
      ...
      "windows-sys" = rec {
        ...
        resolvedDefaultFeatures = [ "Win32" "Win32_Foundation" "Win32_Networking" "Win32_Networking_WinSock" "Win32_Security" "Win32_Storage" "Win32_Storage_FileSystem" "Win32_System" "Win32_System_Console" "Win32_System_Diagnostics" "Win32_System_Diagnostics_Debug" "Win32_UI" "Win32_UI_Input" "Win32_UI_Input_KeyboardAndMouse" "default" ];
      };
